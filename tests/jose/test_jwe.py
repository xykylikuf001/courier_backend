...
from app.utils.jose import jwe
from app.utils.jose.constants import ALGORITHMS, ZIPS
from app.utils.jose.exceptions import JWEParseError
from app.utils.jose.jwk import AESKey, RSAKey
from app.utils.jose.utils import base64url_decode

backends = []
try:
    from app.utils.jose.backends import cryptography_backend  # noqa E402

    backends.append(cryptography_backend)
except ImportError:
    pass

import app.utils.jose.backends.native  # noqa E402
...
backends.append(app.utils.jose.backends.native)
