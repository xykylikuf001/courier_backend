...
try:
    from app.utils.jose.backends.rsa_backend import RSAKey as PurePythonRSAKey
except ImportError:
    PurePythonRSAKey = None
try:
    from app.utils.jose.backends.cryptography_backend import CryptographyECKey, CryptographyRSAKey
except ImportError:
    CryptographyRSAKey = CryptographyECKey = None
try:
    from app.utils.jose.backends.ecdsa_backend import ECDSAECKey as PurePythonECDSAKey
except ImportError:
    PurePythonRSAKey = None

try:
    from app.utils.jose.backends.cryptography_backend import CryptographyAESKey
except ImportError:
    CryptographyAESKey = None
try:
    from app.utils.jose.backends.cryptography_backend import CryptographyHMACKey
except ImportError:
    CryptographyHMACKey = None

from app.utils.jose.backends import ECKey, HMACKey, RSAKey
from app.utils.jose.backends.native import HMACKey as NativeHMACKey

try:
    from app.utils.jose.backends import AESKey
except ImportError:
    AESKey = None
