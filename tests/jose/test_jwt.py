...
from app.utils.jose import jws, jwt
from app.utils.jose.exceptions import JWTError
...
class TestJWT:
    ...
    def test_invalid_claims_json(self):
        ...
        try:
            ...
            def return_invalid_json(token, key, algorithms, verify_it=True):
                return b'["a", "b"}'
    ...
    def test_invalid_claims(self):
        ...
        try:
            ...
            def return_encoded_array(token, key, algorithms, verify_it=True):
                return b'["a","b"]'
